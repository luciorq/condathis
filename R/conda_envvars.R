#' Build clean Conda and Mamba environment variables
#'
#' Returns a named list of Conda and Mamba environment variables configured for
#' isolation from external Conda installations.
#'
