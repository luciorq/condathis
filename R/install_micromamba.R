...
#'   Micromamba to download. Defaults to `"2.6.2-1"`.
#'
...
#' ```
#' curl -sL https://github.com/mamba-org/micromamba-releases/releases/download/2.6.2-1/micromamba-osx-arm64.sha256
#' ```
#'
