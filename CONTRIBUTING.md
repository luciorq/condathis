...
This outlines how to propose a change to condathis. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("luciorq/condathis", fork = TRUE)`.
...
Please note that the Condathis project is released with a [Contributor
Code of Conduct](https://luciorq.github.io/condathis/CODE_OF_CONDUCT.md)
derived from the [Contributor
Covenant](https://www.contributor-covenant.org/) v2.1. By contributing
